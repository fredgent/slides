...
%  \newrgbcolor{myred}{0.9 0 0.1}
  \definecolor{mymidblue}{RGB}{0 0.2 0.7}
  ...
  \subsection{What does it take to get a galactic dynamo?} 
    \begin{frame}
      \frametitle{What does it take to get a galactic dynamo?}
       \includemovie[draft]{12.0cm}{5.6cm}{ism.mp4}
       %%\includemedia[autoplay,width=6.0cm,height=5.6cm,activate=pagevisible,deactivate=pageinvisible]{\includegraphics[width=6.0cm]{rho.avi.jpg}}{rho.avi}
       %%\includemedia[width=6.0cm,height=5.6cm,activate=pagevisible,deactivate=pageinvisible,draft]{\includegraphics[width=6.0cm]{rho.avi.png}}{rho.avi}
       %\includemedia[width=6.0cm,keepaspectratio,activate=pagevisible,addresource=rho.avi,final]{\includegraphics[]{rho.avi.png}}{rho.avi}
    \end{frame}
%----------------------------------------------------------------------------
    \begin{frame}
    ...
    \begin{columns}
      \begin{column}[]{6.5cm}
      \includegraphics[trim=0.5cm 0.0cm 0.3cm 0.0cm, clip=true,width=\textwidth]{letterfigs/eB-Bals.pdf}
      {\footnotesize{
...
%----------------------------------------------------------------------------
    ...
    \begin{columns}
      \begin{column}[]{6.5cm}
      \includegraphics[trim=0.5cm 0.0cm 0.3cm 0.0cm, clip=true,width=\textwidth]{letterfigs/eB-res-4eta.pdf}
      {\footnotesize{
